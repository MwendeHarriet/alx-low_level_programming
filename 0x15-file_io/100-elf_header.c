...
/**
 * check_elf - this checks whether a file is ELF or not
 * and exit at 98 if file is not an ELF
...
/**
 * print_magic -this prints magic numbers for an ELF header
 * and magic nubers will be separated by spaces
 ...
 * @e_ident: pointer to array withg the ELF class
 */
...
/**
 * close_elf - this closes an ELF file and exits at 98
 ...
 * description: exits at 98 if the file is not an ELF
 * or function fails
 * * Return: 0 on success
 */
